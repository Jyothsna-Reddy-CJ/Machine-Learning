...
if __name__ == "__main__":
    ...
    # Plotting using variable names instead of hardcoded values
    epochs = range(1, len(training_losses) + 1)  # Dynamically set the number of epochs
    ...
    plt.plot(epochs, validation_accuracies, label='Val Accuracy')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    ...
    plt.plot(epochs, validation_accuracies, label='Val Accuracy', color='green')
    plt.xlabel('Epochs')
    plt.ylabel('Value')
