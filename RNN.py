...
if __name__ == "__main__":
    ...
    # Loss subplot
    plt.subplot(1, 2, 1)
    plt.plot(epochs_range, training_losses, label='Training Loss', color='blue', marker='o')
    plt.plot(epochs_range, validation_losses, label='Validation Loss', color='orange', marker='x')
    ...
    # Accuracy subplot
    plt.subplot(1, 2, 2)
    plt.plot(epochs_range, training_accuracies, label='Training Accuracy', color='blue', marker='o')
    plt.plot(epochs_range, validation_accuracies, label='Validation Accuracy', color='orange', marker='x')
    ...
    # Additional plot for Training Loss vs Validation Accuracy
